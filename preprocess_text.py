...
def main(arguments):
    ...
    parser.add_argument('--vocabminfreq', help="Minimum frequency for vocab, if using frequency cutoff",
                                                type=int, default=-1)    
    parser.add_argument('--trainfile', help="Path to training data.", default='data/ptb/train.txt')
    parser.add_argument('--valfile', help="Path validation data.", default='data/ptb/val.txt')
    parser.add_argument('--testfile', help="Path to test data.", default='data/ptb/test.txt')
    ...
    parser.add_argument('--outputfile', help="Prefix of the output file names. ", default='data/ptb/ptb', type=str)
